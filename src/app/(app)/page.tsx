        ...
        sections={[
          <div className="flex-1">
            <p className="text-zinc-700 dark:text-zinc-300">
              ...
              <Link
                href="https://www.skillrev.dev"
                className="hover:text-zinc-900 dark:hover:text-zinc-100"
                target="_blank"
              >
                skillrev
              </Link>
              . I have assisted more than 6 start-ups by building and scaling
              their technical infrastructure and product development. In
              addition to that, I keep{' '}
              <Link
                href="/music"
                className="hover:text-zinc-900 dark:hover:text-zinc-100"
              >
              ...
              {WORK_EXPERIENCE.map((job) => (
                ...
                >
                  <Spotlight
                    ...
                    size={64}
                  />
                  <div className="relative h-full w-full bg-white p-4 dark:bg-[#111111]">
          ...
          <div className="border-t-[0.5px] border-zinc-200 pt-4 dark:border-zinc-800">
            <div>
              My PGP key:{' '}
              <Link
