...
function Projects() {
    ...
    return (
        <section className='mx-auto max-w-3xl lg:px-0 px-5'>
            <h1
                className='text-4xl font-bold text-center lg:text-left my-2'
            >Projects</h1>
            <p
            ...
            >
                {projects.map(project => (
                    <div key={project.id}
                    className='transition duration-300 ease-in-out transform hover:-translate-y-1 lg:hover:scale-105 p-1'
                    >
                        <img src={project.image} 
                        className='w-full lg:h-52 h-48 max-w-sm mx-auto object-cover border-2 border-gray-200 p-1'
                        alt={project.title} />
                        <h2
                        className='text-xl font-bold my-2 text-center lg:text-left'
                        >{project.title}</h2>
                        <p
