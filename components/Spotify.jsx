...
function Spotify() {
  ...
  return (
    <section className="max-w-3xl mx-auto lg:p-0 p-5 ">
      <div className="flex flex-row-reverse items-center sm:flex-row mb-8 space-x-0 sm:space-x-2 w-full"> 
        ...
        <div className="inline-flex flex-col sm:flex-row w-full max-w-full truncate">
          ...
          <span className="capsize mx-2 dark:text-gray-500 text-gray-300 hidden sm:block">
            {" – "}
          </span>
          {data?.isPlaying ? (
            ...
            <p className="capsize dark:text-gray-500 text-gray-300 max-w-max truncate">Is sleeping 🛌</p>
          )}
        </div>
      </div>
    </section>
