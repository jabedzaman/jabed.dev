---
title: Triple Play - macOS, Linux, and Windows Harmony with KVM, DistroBox, and Wine
slug : triple-play-macos-linux-and-windows-harmony-with-kvm-distrobox-and-wine
summary: A guide to run macOS, Linux distributions, and Windows together on a single machine with KVM, DistroBox, and Wine.
date: 2023-09-22
tags: macos, linux, windows, kvm, distrobox, wine, docker, distrobox, virtualization, virtualbox, qemu, virtual-mac
---
...
OKAY ITS MUST TO HAVE A LINUX HOST FOR THIS TO WORK. I use [Arch Linux](/posts/the-arch-linux-cult) BTW.
...
![Fedora running in a container on my Arch Linux host](/images/distrobox.png)
...
This was how you can run macOS, Linux, and Windows together on a single machine with KVM, DistroBox, and Wine. Personally just [Arch](/posts/the-arch-linux-cult) is enough for me. I am loyal to Arch even more than my disillusional girlfriend. But if you need to run all three of them, this is the way to go.