...
slug: a-hitchhokers-guide-to-installing-arch-linux
summary: A no non-sense installtion guide for arch linux
date: 2023-10-01
tags: arch, unixporn, linux, installtion, 
---
...
```bash
mount /mnt /dev/your_root_partition
mount /mnt/boot/efi /dev/your_boot_partiton
mount /mnt/home /dev/your_home_partition # if you made a seperate home partiton
```
